  ...
  return (
    <div className="py-7">
      <div className="wrapper flex flex-col gap-3 items-center">
        ...
        >
          <div className="relative bg-[#E7C151] rounded-xl px-6 pt-6 pb-[4rem] h-full w-full">
              ...
              {testimonials.map((item) => (
                ...
                >
                  <div className="flex items-center gap-2">
                    ...
                    />
                    <div>
                      <h4 className="text4 text-black">{item.author}</h4>
                      <p className="text-black/70">{item.position}</p>
                    </div>
                  </div>
                  <p className="desc text-black">{item.quote}</p>
                </div>
              ))}
            </div>
            <div className="absolute flex w-fit items-center gap-5 z-[1] right-[3rem] bottom-6">
              <button onClick={handlePrevClick}>
                <GoArrowLeft
                  size={30}
                  className="fill-black hover:fill-black/70"
                />
              </button>
