...
const BlogDetails = () => {
  ...
  return (
    <div className="mt-[5.5rem] lg:mt-[9rem] min-h-screen text-white max-w-[100vw]">
      {/* Meta Tags */}
      <Helmet>
        <title>{blog.title} | Orvanta AI</title>
        ...
        <div className="">
          ...
          <div className="mt-16 p-8 bg-gradient-to-r from-gray-800 to-gray-900 rounded-xl border border-gray-700 text-center">
            ...
            <p className="text-gray-300 mb-6 max-w-2xl mx-auto">
              Let's discuss how our web development, mobile app, or AI solutions
              can help your business grow. Schedule a free consultation today.
            </p>
            <Link
              to="/contact-us"
